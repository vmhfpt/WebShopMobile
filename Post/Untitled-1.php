...
<nav class="navbar navbar-expand-sm bg-dark navbar-dark">
  ...
  <div style="float: left;width : 200px;margin-right : 15px; margin-left:15px" class="form-group">
    <input name="seacher" style="border-radius : 30px;" type="text" class="form-control" placeholder="Enter Name Product" autocomplete = "off" onkeyup="showHint(this.value)" id="email" value="<?=$seacher?>">
  </div>
...
<a href="product.php?id=<?=$value['id']?>">  <div class="roundStar">
  ...
  <?php } if ($j <= 5){
     ...
     if(count($result) - 12 > 0){
     //  echo count($result) - 4 ;
     ?>
    <center> <a href="javascript:More(2,'<?=$filter?>', 0);"> <button style="color : blue !important ;
  margin : 40px ;
  border : 1px solid #000000" type="button" class="btn btn-outline-light text-dark">Xem Thêm <?php echo (count($result) - 12);?> Sản Phẩm</button> </a></center>
  <?php
  }
  ?>
    </div>
